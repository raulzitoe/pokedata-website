...
<html>
	...
	<body>
		<form action="admin.php" method="POST" enctype="multipart/form-data"> <!--I want to run the script as soon as I click the submit button to which I'm adding the connection.  -->
